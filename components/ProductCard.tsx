    ...
    <Link href={`/products/${product.slug}`} className="group block">
      <div className="product-card bg-white rounded-3xl overflow-hidden h-full flex flex-col border border-[#D4C9B8]">
        ...
        <div className="relative aspect-[4/3.2] bg-[#F4EDE3] overflow-hidden">
          ...
          />
          {hasSale && (
            <div className="absolute top-4 right-4 bg-[#6B2D3C] text-white text-xs px-3.5 py-1 rounded-full font-medium tracking-wider">
              SALE
            </div>
          )}
        ...
        <div className="p-5 flex-1 flex flex-col">
          ...
          <button
            ...
            className="mt-5 w-full flex items-center justify-center gap-2 py-3 text-sm font-medium border border-[#D4C9B8] hover:bg-[#6B2D3C] hover:text-white hover:border-[#6B2D3C] active:bg-[#4A1F2A] rounded-2xl transition-all group-hover:border-[#6B2D3C]/70"
          >
